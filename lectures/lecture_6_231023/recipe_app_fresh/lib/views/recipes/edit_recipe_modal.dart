  ...
  void initState() {
    ...
    _offsetAnimation = TweenSequence<Offset>([
      TweenSequenceItem(
        weight: 1.0,
        tween: Tween<Offset>(
          begin: const Offset(0.5, 0.5), // bottom right
          end: const Offset(-0.35, -0.35), // top left
        ),
      ),
      TweenSequenceItem(
        weight: 1.0,
        tween: Tween<Offset>(
          begin: const Offset(-0.35, -0.35), // top left
          end: const Offset(0.2, 0.2), // middle right
        ),
      ),
      TweenSequenceItem(
        weight: 1.0,
        tween: Tween<Offset>(
          begin: const Offset(0.2, 0.2), // middle right
